...
public class Pengemudi extends javax.swing.JFrame {
    ...
    public Pengemudi() {
        ...
        table_Pengemudi.setModel(tableModel);
        settableload();
    }
    ...
    private javax.swing.table.DefaultTableModel getDefaultTableModel() {
        ...
        return new javax.swing.table.DefaultTableModel(
                new Object[][]{},
                new String[]{"Id Supir", "Nama", "No Handphone", "Alamat"}
    ...
    private void settableload() {
        ...
        try {
            ...
            String SQL = "select * from pengemudi";
    ...
    {
        row = table_Pengemudi.getSelectedRow();
    ...
    private void initComponents() {
        ...
        table_Pengemudi = new javax.swing.JTable();
        ...
        jPanel1.add(txt_Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(306, 203, 187, 29));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(266, 418, 260, 150));

        table_Pengemudi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id Supir", "Nama", "No Handphone", "Alamat"
            }
        ));
        table_Pengemudi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                table_PengemudiMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(table_Pengemudi);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 235, 683, 304));
        jPanel1.add(txt_Cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(682, 558, 597, 29));
        ...
        jPanel1.add(btn_Cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(596, 557, 50, 29));
        ...
        jPanel1.add(btn_Simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(578, 650, 80, 24));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1228, 82, -1, -1));
    ...
    private void btn_SimpanMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_SimpanMousePressed
        ...
        else
        {
            try
            {
                ...
                Connection kon = DriverManager.getConnection(database, user, pass);
                Statement stt = kon.createStatement();
                String SQL = "INSERT INTO pengemudi(Id_Supir,"+ "Nama,"+ "No_Hp,"+ "Alamat)"
                + "VALUES"
                +"( '"+txt_Id.getText()+"',"
                +"'"+txt_Nama.getText()+"',"
                +"'"+txt_Hp.getText()+"',"
    ...
    private void table_PengemudiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_PengemudiMouseClicked
        // TODO add your handling code here:
         if(evt.getClickCount()==1)
        {
            tampil_field();
        }
    }//GEN-LAST:event_table_PengemudiMouseClicked
    ...
    private void btn_UbahMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_UbahMousePressed
        ...
        if((Id_Supir.isEmpty()) | (Alamat.isEmpty()))
        {
        ...
        else
        {
            try
            {
                ...
                Connection kon = DriverManager.getConnection(database, user, pass);
                Statement stt = kon.createStatement();
                String SQL = "UPDATE `pengemudi`"
                +"SET `Id_Supir`='"+Id_Supir+"',"
                +"`Nama`='"+Nama+"',"
                +"`No_Hp`='"+No_Telp+"',"
                +"`Alamat`='"+Alamat+"'"      
                +"WHERE"
                +"`Id_Supir`='"+tableModel.getValueAt(row, 0).toString()+"';";
                data[0] = Id_Supir;
                data[1] = Nama;
                data[2] = No_Telp;
                data[3] = Alamat;
    ...
    private void btn_HapusMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_HapusMousePressed
        ...
        try
        {
            ...
            Connection kon = DriverManager.getConnection(database, user, pass);
            Statement stt = kon.createStatement();
            String SQL = "Delete from `travel1`.`pengemudi`"
            +"where"
            +"`Id_Supir`='"+tableModel.getValueAt(row, 0).toString()+"';";
            stt.executeUpdate(SQL);
            tableModel.removeRow(row);
    ...
    private void btn_CariMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_CariMousePressed
        ...
        try {
            if ("Masukan id Supir/Nama".equals(tampung) || "".equals(tampung)) {
                ...
                Connection kon = DriverManager.getConnection(database, user, pass);
                Statement stt = kon.createStatement();
                String SQL = "select * from `travel1`.`pengemudi` WHERE `Id_Supir`like '%" + txt_Cari.getText() + "%'OR `Nama` like '%" + txt_Cari.getText() + "'";
                ResultSet res = stt.executeQuery(SQL);
                while (res.next()) {
                    data[0] = res.getString(1);
                    data[1] = res.getString(2);
    ...
    private javax.swing.JTable table_Pengemudi;
